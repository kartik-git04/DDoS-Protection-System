...
threshold = np.percentile(y_train, 95)  # 95th percentile
...
# =======================
# Reload the full CSV to get Source IPs
full_df = pd.read_csv(csv_file_path, low_memory=False)
full_df.columns = full_df.columns.str.strip()

if 'Source IP' in full_df.columns:
    full_df['Anomaly'] = 0
    anomaly_indices = detected_anomalies['Index'] + seq_length  # shift index due to sequence length
